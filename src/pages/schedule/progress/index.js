...
export default function ManageProgressPage(props) {
    ...
    const [columns, setColumns] = useState(getDefaultConfigTable("progress"))
            ...
            getTimelineApi({
                ...
                if (r.data) {
                    ...
                    for (let i = 0; i < result.length; i++) {
                        ...
                        result[i].projectStatus = result[i].projectStatus?result[i].projectStatus.name:""
    ...
    const removeApi = (body) => {
        return apiProgress.delete(body)
    }
                    ...
                    <div className={'children-organization'}>
                        <div className={'table-content'} style={{marginTop: '10px'}}>
                            <div className={'table-content-title'}
                                ...
                                Tiến độ dự án: {infoProject.name}
                                ...
                                <div style={{
                                    ...
                                    {/*}*/}
                                    {
                                        currentUser.roles.includes("create_progress") ?
                                                        ...
                                                        <TableRow>
                                                            ...
                                                            <TableCell className={"action"}
                                                                ...
                                                                <div className={'icon-action'} style={{
                                                                    ...
                                                                    {
                                                                        currentUser.roles.includes('update_progress')?
                                                                    ...
                                                                    {
                                                                        currentUser.roles.includes('delete_progress')?
                                                                            <Tooltip arrow disableInteractive
                                                                                     placement="right-start"
                                                                                     title={"Xóa"}>
                                                                                <DeleteForeverIcon
